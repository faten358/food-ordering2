...
import 'package:food_ordering2/core/data/models/apis/map_model.dart';
...
import 'package:food_ordering2/core/utils/map_util.dart';
...
class MapController extends BaseController {
  ...
  //for api included name all of countries and markers
  List <MapModel> resultMap= [];
  ...
  void onInit() {
    ...
    selectedLocation = LatLng(currentLocation.latitude ?? 37.43296265331129,
        currentLocation.longitude ?? -122.08832357078792);
          countryJsonList.forEach(
            (element) { 
              resultMap.add(MapModel.fromJson(element));
            markers.add(Marker(
              //markerID is uniqe for one location
              markerId: MarkerId(MapModel.fromJson(element).country!),
              position: LatLng(MapModel.fromJson(element).latitude!.toDouble(),
                               MapModel.fromJson(element).longitude!.toDouble(),) 
              ));
            },
  ...
  void addMarker(
    ...
    //included getX becouse return build all view
    update();
  }
