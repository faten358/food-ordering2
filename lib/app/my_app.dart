...
import 'package:food_ordering2/ui/views/signup_view/signup_view.dart';
import 'package:food_ordering2/ui/views/splash_screen/splash_screen_view1.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    //get for packages get
    return GetMaterialApp(
      //for animation between pages
      defaultTransition: Transition.cupertino,
      transitionDuration: Duration(microseconds: 300),
      //for multi language
      translations: AppTranlation(),
      //locale is responsible for en , ar from left and right
      //it is read only first run time
        locale: getLocal(),
        //it is read during all run app
